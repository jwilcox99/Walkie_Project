...
// ---------- Case ----------
case_h = 145;
case_w = 68;        // MK1.1: widened 3 mm for wiring clearance
case_d = 38;
...
heltec_standoff_h = 18;        // raise/lower board here
heltec_post_d = 5.0;
heltec_clip_w = 4.0;
...
ptt_hole_d = 24.4;
ptt_depth = 28;
channel_hole_d = 16.3;  // MK1.1: +0.8 mm for easier fit
channel_depth = 17;
power_hole_d = 7.4;    // MK1.1: +1.7 mm for easier fit
power_depth = 16;
...
mic_standoff_h = 5.0;
mic_screw_d = 2.0;
mic_mount_hole_spacing = 11;
mic_mount_y_offset = 6;
mic_mount_x_offset = 0;
...
oled_x = 0;
heltec_x =4;
battery_x = 5.5;       // MK1.1: moved 2.5 mm toward center
amp_x = -18;
speaker_x = 0;
mic_x = 0;
